...
This paper by [Huay et al.(2016)](https://www.sciencedirect.com/science/article/pii/S235293851630129X)

![](images/clipboard-4190448481.png)

### Mapping Informal Settlements in Developing Countries using Machine Learning and Low Resolution Multi-spectral Data

This paper by [Gram-Hansen et al.(2019)](https://dl.acm.org/doi/pdf/10.1145/3306618.3314253)

![](images/clipboard-987288024.png)

*Predictions of informal settlements (white pixels) in Kibera, Nairobi. Left: The CCF prediction of informal settlements
in Kibera on low-resolution Sentinel-2 spectral imagery. Middle: Deep learning based prediction of informal settlements in
Kibera, trained on VHR imagery. Right: The ground truth informal settlement mask for Kibera.*
